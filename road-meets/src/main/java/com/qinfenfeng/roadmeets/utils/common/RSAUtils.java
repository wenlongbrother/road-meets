...
public class RSAUtils {
    ...
    public static void main(String[] args) throws Exception {
        String publicKey = "";
        String privateKey = "";
        Map<String, Object> keyMap = RSAUtils.init();
        ...
        String str = "long";
        byte[] enStr = RSAUtils.encryptByPublicKey(str, publicKey);
        String decStr = RSAUtils.decryptByPrivateKey(enStr, privateKey);
        ...
        boolean flag = RSAUtils.verify(str.getBytes(), publicKey, sign);
